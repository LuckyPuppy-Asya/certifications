...
let slider_sertificates = new Swiper('.sertificates__slider', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
	...
	*/
	...
	// Arrows
	navigation: {
		nextEl: '.sertificates__arrow__next',
		prevEl: '.sertificates__arrow__prev',
	},
...
//использую ф-цию _slideToggle из functions.js, line-458
let menuFooterBurger1 = document.querySelector('.menu-footer__burger_1');
let menuFooterBody1 = document.querySelector('.menu-footer__body_1');
menuFooterBurger1.addEventListener("click", function (e) {
	menuFooterBurger1.classList.toggle('_active');
	_slideToggle(menuFooterBody1);
});

let menuFooterBurger2 = document.querySelector('.menu-footer__burger_2');
let menuFooterBody2 = document.querySelector('.menu-footer__body_2');
menuFooterBurger2.addEventListener("click", function (e) {
	menuFooterBurger2.classList.toggle('_active');
	_slideToggle(menuFooterBody2);
});

// Прокрутка при клике в меню в footer
const menuFooterLinks = document.querySelectorAll('.menu-footer__link[data-goto]');
if (menuFooterLinks.length > 0) {
	menuFooterLinks.forEach(menuFooterLink => {
		menuFooterLink.addEventListener("click", onMenuFooterLinkClick);
	});

	function onMenuFooterLinkClick(e) {
		const menuFooterLink = e.target;
		if (menuFooterLink.dataset.goto && document.querySelector(menuFooterLink.dataset.goto)) {
			const gotoBlock = document.querySelector(menuFooterLink.dataset.goto);
			const gotoBlockValue = gotoBlock.getBoundingClientRect().top + pageYOffset - document.querySelector('header').offsetHeight;
